...
void user::Login()
{
        ...
        int flag=1;
        int choice;
        details Mumbai_Indians(18,6,130500000,3,7,5,3);
        details Royal_Challengers_Bangalore(13,2,279000000,4,4,4,1);
        details Kolkata_Knight_Riders(14,4,356500000,4,7,2,1);
        details Chennai_Super_Kings(18,6,146000000,5,6,5,2);
        details Kings_XI_Punjab(12,4,427000000,5,7,0,2);
        details Delhi_Capitals(14,3,278500000,4,5,4,1);
        details Sun_Risers_Hyderabad(18,6,170000000,3,9,3,3);
        details Rajasthan_Royals(14,4,289000000,4,6,2,2);
        details yourteam;
